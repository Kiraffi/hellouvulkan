...
spirv-opt assets/shader/vulkan/frag_2.spv -o assets/shader/vulkan/frag_2.spv
spirv-opt assets/shader/vulkan/vert_2.spv -o assets/shader/vulkan/vert_2.spv

spirv-opt assets/shader/vulkan/vert_1.spv -o assets/shader/vulkan/vert_1.spv
spirv-opt assets/shader/vulkan/frag_1.spv -o assets/shader/vulkan/frag_1.spv

spirv-opt assets/shader/vulkan/triangle_vert.spv -o assets/shader/vulkan/triangle_vert.spv
spirv-opt assets/shader/vulkan/triangle_frag.spv -o assets/shader/vulkan/triangle_frag.spv

spirv-opt assets/shader/vulkan/compute_comp.spv -o assets/shader/vulkan/compute_comp.spv
spirv-opt assets/shader/vulkan/computereset_comp.spv -o assets/shader/vulkan/computereset_comp.spv
spirv-opt assets/shader/vulkan/computecarpwrite_comp.spv -o assets/shader/vulkan/computecarpwrite_comp.spv
spirv-opt assets/shader/vulkan/compute_create_instances_comp.spv -o assets/shader/vulkan/compute_create_instances_comp.spv
